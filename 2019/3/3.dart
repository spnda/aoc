...
class Wire {
  ...
  Wire(this.x, this.y, this.direction);

  void move(List<List<int>> matrix, int identifier) {
    List<String> dirs = direction.split(",");
    for (int i = 0; i < dirs.length; i++) {
      String dir = dirs[i];
      switch (dir[0]) {
        case "U":
          int distance = getDistanceForDir(dir);
